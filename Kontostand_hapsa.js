fetch('Kontostand.txt')
    ...
    .then(text => {
        ...
        document.getElementById('Kontostand').textContent = formattedText;
    })
    .catch(error => {
        document.getElementById('Kontostand').textContent = 'Fehler beim Laden der Datei: ' + error;
    });
