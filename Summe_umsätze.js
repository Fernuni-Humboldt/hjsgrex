fetch('Summe_umsätze.txt')
    ...
    .then(text => {
        ...
        document.getElementById('Summe_umsätze').textContent = formattedText;
    })
    .catch(error => {
        document.getElementById('Summe_umsätze').textContent = 'Fehler beim Laden der Datei: ' + error;
    });
